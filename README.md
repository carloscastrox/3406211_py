...
Ejercicio 1.1 – Registro de usuario: Crear un algoritmo que permita registrar los datos de un usuario. El programa debe solicitar: nombre, edad y ciudad de residencia. Luego, mostrar un mensaje personalizado con el siguiente formato: "Hola [nombre], tienes [edad] años y vives en [ciudad]." Validar que la edad sea un número positivo.
